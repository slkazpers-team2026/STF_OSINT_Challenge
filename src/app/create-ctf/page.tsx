...
export default function CreateCTFPage() {
  ...
  // User load වෙනකම් හෝ ලොග් වෙලා නැත්නම් පෙන්වන UI එක
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Firebase ctfs collection එකට දත්ත ඇතුලත් කිරීම
      ...
      // සාර්ථකව save වුණාට පස්සේ අලුත් CTF එකේ පිටුවට redirect කරනවා
