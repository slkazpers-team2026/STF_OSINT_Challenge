    ...
    return (
      <div className="min-h-screen bg-gray-950 text-red-500 font-mono flex items-center justify-center p-8">
        <div className="max-w-md p-6 bg-red-950/20 border border-red-800 rounded text-center shadow-lg">
          ...
          <Link href="/" className="inline-block px-4 py-2 bg-red-900/60 hover:bg-red-800 text-white rounded transition-colors text-sm border border-red-700 font-mono">
            Exit Settings
          </Link>
        </div>
      </div>
      ...
      <div className="w-full max-w-md p-6 bg-gray-900 border border-cyan-800 rounded shadow-2xl">
        ...
        <div className="mb-6 border-b border-cyan-900 pb-3 flex justify-between items-center">
          <div>
            ...
            <p className="text-[10px] text-cyan-700 mt-0.5">Manage agent authorization profiles.</p>
          </div>
          <Link href="/" className="text-xs text-gray-500 hover:text-cyan-400 transition-colors uppercase">
            [Close]
          </Link>
        </div>
        ...
        {sysMessage && (
          <div className={`p-3 mb-6 border rounded text-xs ${sysMessage.isError ? 'bg-red-950/20 border-red-800 text-red-400' : 'bg-green-950/20 border-green-800 text-green-400'}`}>
        ...
        <form onSubmit={handleUpdateName} className="space-y-6">
          <div>
            <label className="block text-xs font-bold uppercase tracking-wider text-cyan-500 mb-2">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 bg-black/40 px-3 py-2 rounded border border-gray-800 font-mono">
              {user.email}
            </p>
          </div>
          ...
          <button
            ...
            className="w-full py-2.5 px-4 bg-cyan-950/40 hover:bg-cyan-900/60 border border-cyan-700 hover:border-cyan-500 text-cyan-400 font-bold rounded transition-colors tracking-wide font-mono uppercase text-xs disabled:opacity-40"
          >
        ...
        <div className="space-y-4">
          <div>
            ...
            <button
              ...
              className={`w-full py-2.5 px-4 border text-xs font-bold rounded transition-all font-mono uppercase ${
                resetSent
